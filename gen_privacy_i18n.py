...
SRC = {
    ...
    "h_games": "Games",
    "games": "My games (such as Ink Survivors) additionally use Google Firebase Analytics and Crashlytics so I can find crashes and improve the game. These services collect device information and anonymous gameplay events under Google's own privacy policy; nothing identifies you personally to me and nothing is sold. Game progress is saved only on your device. A future update may offer an optional Google Play Games sign-in for achievements, leaderboards and cloud saves; Google then processes your Play Games profile name, avatar and scores. Signing in is always optional and the games are fully playable without it.",

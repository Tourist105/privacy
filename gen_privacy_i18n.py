...
SRC = {
    ...
    "third1": "Google AdMob shows one banner ad in each app. It may receive your advertising ID, a rough location based on your IP address, and your device, operating system and app version. Google's own privacy policy governs that. You can reset your advertising ID or turn off personalised ads in your device settings.",
    ...
    "notx": "No tracking, no profiling, no fingerprinting, no cookies, no selling of data, and no analytics tools such as Firebase Analytics or Crashlytics.",
    "h_perm": "Permissions",
